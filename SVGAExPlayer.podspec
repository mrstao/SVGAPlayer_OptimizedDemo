...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "runtian"
  # spec.authors            = { "runtian" => "zengruntian91@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/runtian"
  ...
  spec.source_files  = 'SVGAExPlayer/Classes/**/*'
